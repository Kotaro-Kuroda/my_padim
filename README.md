...
&\qquad+ \sum_{i=1}^{n_{2}}(\boldsymbol{x}_{i} - \boldsymbol{\mu}_{n_{2}} +\boldsymbol{\mu}_{n_{2}} - \boldsymbol{\mu})(\boldsymbol{x}_{i} - \boldsymbol{\mu}_{n_{2}} +\boldsymbol{\mu}_{n_{2}} - \boldsymbol{\mu}) ^{T}\Bigg]\\
&= \frac{1}{n - 1} \Bigg[
...
&\qquad + \sum_{i=1}^{n_2} \left((\mathbf{x}_i - \boldsymbol{\mu}_{n_2})(\mathbf{x}_i - \boldsymbol{\mu}_{n_2})^{T}
